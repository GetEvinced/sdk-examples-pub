...
public class EvincedSetupExample
{
    ...
    public void setup() {
        ...
        EvincedSDK.setOfflineCredentials(System.getenv("EVINCED_SERVICE_ID"), System.getenv("EVINCED_WEB_OFFLINE_TOKEN"));
    ...
    public void saveReports() throws MalformedURLException {
        try {
            ...
            EvincedReporter.evSaveFile("landing_page_report", landingPageReport, EvincedReporter.FileFormat.HTML_v2_1);
